...
public class Day01 {
    ...
    public static LinkedHashMap<String, String> numberMap = new LinkedHashMap<>()
    {{
        put("one","1");
        put("two","2");
        put("three","3");
    ...
    public static void main(String[] args) {
        String[] lines = INPUT.replaceAll("[a-zA-Z]", "").split("\n");
        System.out.println(Stream.of(lines).mapToInt(value ->
                Integer.parseInt(value.charAt(0) + value.substring(value.length() - 1))).sum());
    }
